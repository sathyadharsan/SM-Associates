...
export default function BlogsPage() {
  return (
    <div className="space-y-12">
      ...
      >
        <h3 className="text-2xl font-semibold text-gray-950">Blogs</h3>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        >
          <h4 className="text-lg font-semibold text-gray-950">Recovery Trends 2024</h4>
        ...
        <motion.div
          ...
          className="glass-card rounded-[24px] p-6"
        >
          <h4 className="text-lg font-semibold text-gray-950">SARFAESI Deep Dive</h4>
        ...
        <motion.div
          ...
          className="glass-card rounded-[24px] p-6"
        >
          <h4 className="text-lg font-semibold text-gray-950">Risk Intelligence</h4>
