...
export default function InsightsPage() {
  return (
    <div className="space-y-12">
      ...
      >
        <h3 className="text-2xl font-semibold text-blue-950">Insights</h3>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        >
          <h4 className="text-lg font-semibold text-blue-950">Recovery Benchmarks</h4>
        ...
        <motion.div
          ...
          className="glass-card rounded-[24px] p-6"
        >
          <h4 className="text-lg font-semibold text-blue-950">Compliance Updates</h4>
