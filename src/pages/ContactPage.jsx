    ...
    <section className="relative min-h-screen bg-white pt-32 pb-20 sm:pt-36 lg:pb-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="glass-card rounded-[32px] p-10 lg:p-16">
          <h1 className="text-4xl font-semibold tracking-[-0.055em] text-blue-950 sm:text-5xl lg:text-7xl">Contact Us</h1>
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-bold text-blue-950">Phone</p>
                  <p className="text-sm text-slate-500">
                    044-43060206
                    <br />
                    044-48530577
            ...
            <form className="glass-card rounded-[28px] p-8">
              <div className="grid gap-4">
                ...
                <button className="rounded-2xl bg-blue-950 py-3 font-bold text-white transition hover:bg-blue-700">
                  Send Message
                </button>
              </div>
            </form>
