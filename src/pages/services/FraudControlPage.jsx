      ...
      <section className="relative flex min-h-[60vh] items-center justify-center bg-slate-50">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center">
          ...
          <h1 className="mt-6 text-4xl font-semibold tracking-tight text-gray-950 sm:text-5xl">
            Investigation-led Fraud Prevention
          </h1>
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <ul className="mt-6 space-y-4">
              {['Seeding', 'Government Department Liaison', 'Warrant Execution', 'ITR Verification', 'Title Deed Verification', 'Anomaly Detection'].map(item => (
          ...
          <motion.div
            ...
            className="glass-card rounded-[24px] p-8"
          >
            <h3 className="text-2xl font-semibold text-gray-950">Risk Intelligence</h3>
            <p className="mt-4 text-slate-500">
              Reduce fraud leakage through field intelligence, investigation support, and anomaly detection for suspicious lending patterns.
            </p>
