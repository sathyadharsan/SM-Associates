...
export default function PreDisbursalPage() {
  return (
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <ul className="mt-6 space-y-4">
              {['CPV (Customer Profile Verification)', 'CPA (Current Address Verification)', 'Telephone Verification', 'Seeding', 'Skip Tracing', 'Business Authenticity Checks'].map(item => (
          ...
          <motion.div
            ...
            className="glass-card rounded-[24px] p-8"
          >
            <h3 className="text-2xl font-semibold text-gray-950">Benefits</h3>
            <p className="mt-4 text-slate-500">
              Reduce early-stage portfolio leakage through thorough pre-disbursal verification and risk assessment.
            </p>
