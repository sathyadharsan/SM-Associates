    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
          ...
          >
            <h3 className="text-2xl font-semibold text-gray-950">Key Benefits</h3>
          ...
          <motion.div
            ...
            className="glass-card rounded-[24px] p-8"
          >
            <h3 className="text-2xl font-semibold text-gray-950">Service Details</h3>
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-gray-950"
            >
