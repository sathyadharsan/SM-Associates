        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <ul className="mt-6 space-y-4">
              {['DRT Case Follow-up', 'Warrant Execution', 'Police Coordination', 'Advocate Coordination', 'Documentation Support', 'Court Updates'].map(item => (
          ...
          <motion.div
            ...
            className="glass-card rounded-[24px] p-8"
          >
            <h3 className="text-2xl font-semibold text-gray-950">Legal Expertise</h3>
            <p className="mt-4 text-slate-500">
              Coordination with advocates, courts, legal teams, and documentation support for structured recovery.
            </p>
