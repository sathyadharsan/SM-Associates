    ...
    <div className="min-h-screen bg-white">
      <section className="relative flex min-h-[60vh] items-center justify-center bg-slate-50">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center">
          ...
          <h1 className="mt-6 text-4xl font-semibold tracking-tight text-gray-950 sm:text-5xl">
            Claims Investigation &amp; Recovery Support
          </h1>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            <h3 className="text-2xl font-semibold text-gray-950">Services for Insurance</h3>
            <ul className="mt-6 space-y-4">
              {['Claims Investigation', 'Recovery Support', 'Documentation', 'Field Verification', 'Legal Assistance'].map(item => (
          ...
          >
            ...
            <p className="mt-4 text-slate-500">
              Investigative support for insurance claims with professional field teams and documentation expertise.
            </p>
