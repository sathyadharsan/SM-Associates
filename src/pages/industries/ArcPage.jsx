    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            <h3 className="text-2xl font-semibold text-gray-950">Services for ARC</h3>
            <ul className="mt-6 space-y-4">
              {['Stressed Asset Management', 'Enforcement Actions', 'Recovery Execution', 'Documentation Support', 'Legal Coordination'].map(item => (
          ...
          <motion.div
            ...
            className="glass-card rounded-[24px] p-8"
          >
            <h3 className="text-2xl font-semibold text-gray-950">Expertise</h3>
            <p className="mt-4 text-slate-500">
              Operational support for stressed assets, enforcement actions, and recovery execution with proven methodologies.
            </p>
