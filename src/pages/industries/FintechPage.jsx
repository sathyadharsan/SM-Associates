    ...
    <div className="min-h-screen bg-white">
      <section className="relative flex min-h-[60vh] items-center justify-center bg-slate-50">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center">
          ...
          <h1 className="mt-6 text-4xl font-semibold tracking-tight text-blue-950 sm:text-5xl">
            Digital Lender Recovery Solutions
          </h1>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            <h3 className="text-2xl font-semibold text-blue-950">Services for FinTech</h3>
            <ul className="mt-6 space-y-4">
              {['Fast Recovery Operations', 'Data-driven Workflows', 'Compliant Processes', 'Digital Integration', 'Quick Escalation'].map(item => (
          ...
          <motion.div
            ...
            className="glass-card rounded-[24px] p-8"
          >
            <h3 className="text-2xl font-semibold text-blue-950">Digital Advantage</h3>
            <p className="mt-4 text-slate-500">
              Recovery operations designed for digital lenders with fast, compliant, and transparent execution.
            </p>
