...
export const LEAD_FLOW = {
  ...
  steps: [
    ...
    { key: 'name', prompt: 'Your name?' },
    {
      ...
      validate: (v) => PHONE_RE.test(v.trim()) || 'That doesn’t look like a phone number — please re-enter.',
    },
    {
  ...
  complete(answers) {
    ...
    return {
      ...
      suggestions: ['Explore services', 'Case studies'],
    };
  },
};
...
export const FEEDBACK_FLOW = {
  ...
  complete(answers) {
    ...
    return { text: 'Thank you — your feedback has been recorded.', suggestions: ['Explore services', 'Contact the team'] };
  },
};
...
export const handoffAgent = {
  ...
  handle() {
    return {
      ...
      suggestions: ['Leave my details', 'Contact page'],
