...
export function PlatformLayout({ content }) {
  ...
  return (
    <div className="relative min-h-screen bg-[#030712] text-white overflow-x-hidden font-inter">
      ...
      <div className="absolute top-[-10%] left-[30%] h-[500px] w-[500px] rounded-full bg-brand-500/10 blur-[100px] pointer-events-none" />
      ...
      <section className="relative pt-44 pb-24 bg-slate-950 border-b border-slate-900 text-left overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          ...
          <div className="absolute left-[20%] top-[10%] h-[500px] w-[500px] rounded-full bg-brand-500/10 blur-[100px] animate-pulse" />
          <div className="absolute right-[20%] bottom-[10%] h-[400px] w-[400px] rounded-full bg-brand-500/10 blur-[100px] animate-pulse" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <span className="inline-flex items-center gap-2 rounded-full bg-brand-500/10 border border-brand-500/20 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-brand-500 font-mono">
            ...
            >
              <div className="flex items-center justify-between border-b border-white/5 pb-4 mb-4">
                ...
                <div className="rounded bg-brand-500/10 border border-brand-500/20 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-brand-500 font-mono">
                  Online
                </div>
              </div>
              ...
              <div className="bg-slate-950/80 border border-white/5 rounded-xl p-4 font-mono text-[9px] text-left text-slate-500 space-y-1 max-h-[100px] overflow-hidden">
                ...
                <div className="text-brand-500">&gt; Webhook receiver listener active.</div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-[#050914] border-b border-slate-900 text-left">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-4">
          <span className="text-xs font-bold uppercase tracking-widest text-brand-500 font-mono">Unified Console</span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-500 font-mono">Core System Architecture</span>
            ...
            <div className="lg:col-span-5 bg-white/5 border border-white/10 rounded-2xl p-6 text-xs font-mono space-y-2">
              <div className="flex gap-2 items-center"><CheckCircle2 className="h-4 w-4 text-brand-500" /> OAuth2 Auth Connection</div>
              <div className="flex gap-2 items-center"><CheckCircle2 className="h-4 w-4 text-brand-500" /> 256-bit DB Encryption</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#050914] border-b border-slate-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500 font-mono">Operations Console</span>
            <h2 className="text-3xl font-bold font-sora mt-2">Platform Infrastructure Modules</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-3">
              <div className="text-brand-500"><Cpu className="h-5 w-5" /></div>
            ...
            <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-3">
              <div className="text-brand-500"><Activity className="h-5 w-5" /></div>
            ...
            <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-3">
              <div className="text-brand-500"><Database className="h-5 w-5" /></div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5 space-y-6 text-left">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-500 font-mono">Sandbox Environment</span>
            ...
            <div className="lg:col-span-7 bg-[#0b0f19] border border-white/10 rounded-3xl p-6 shadow-2xl text-left relative overflow-hidden">
              <div className="flex items-center justify-between border-b border-white/5 pb-4 mb-4">
                ...
                <div className="flex items-center gap-4 text-[10px] text-slate-500 uppercase tracking-widest font-mono">
                  ...
                  <button onClick={handleCopy} className="text-brand-500 hover:underline hover:text-brand-500 font-bold">
                    {copied ? "Copied!" : "Copy Code"}
                  </button>
                </div>
              </div>
              <pre className="text-xs text-brand-500 font-mono overflow-x-auto select-all max-h-[200px]">
      ...
      <section className="py-20 bg-[#050914] border-b border-slate-900 text-left">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-4">
          <span className="text-xs font-bold uppercase tracking-widest text-brand-500 font-mono">Security Vault</span>
          <h3 className="text-2xl font-bold font-sora flex items-center gap-2">
            <Lock className="h-5 w-5 text-brand-500" /> ISO 27001 Bank-Grade Data Custody
          </h3>
          <p className="text-slate-400 text-sm md:text-base leading-relaxed max-w-3xl">
      ...
      <section className="py-20 bg-[#030712] border-b border-slate-900 text-left">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-4">
          <span className="text-xs font-bold uppercase tracking-widest text-brand-500 font-mono">Auditable Logs</span>
      ...
      <section className="py-20 bg-[#050914] border-b border-slate-900 text-left">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <span className="text-xs font-bold uppercase tracking-widest text-brand-500 font-mono">Ingestion Sync</span>
      ...
      <section className="py-20 bg-[#030712] border-b border-slate-900 text-left">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-500 font-mono">Performance Yields</span>
      ...
      <section className="py-16 bg-[#0a1128] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <h3 className="text-lg font-bold font-sora text-brand-500">Governance Vetting Audits</h3>
      ...
      <section className="py-20 bg-[#030712]">
        <div className="mx-auto max-w-4xl px-4 text-center bg-brand-500 rounded-[32px] p-12 space-y-6 shadow-2xl">
