...
export function InsightsLayout({ content }) {
  ...
  return (
    <div className="relative min-h-screen bg-white text-slate-800 overflow-x-hidden font-inter">
      ...
      <div className="absolute top-[-10%] right-[-10%] h-[600px] w-[600px] bg-blue-500/[0.03] rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[20%] left-[-10%] h-[700px] w-[700px] bg-violet-500/[0.03] rounded-full blur-[140px] pointer-events-none" />
      ...
      <section className="relative pt-48 pb-24 border-b border-slate-200 text-left overflow-hidden bg-white">
        <div className="absolute inset-0 pointer-events-none z-0">
          <div className="absolute left-[10%] top-[20%] h-[400px] w-[400px] rounded-full bg-blue-500/8 blur-[100px] animate-pulse" style={{ animationDuration: '8s' }} />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10 space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 border border-blue-200 px-4 py-1.5 text-xs font-mono font-bold uppercase tracking-widest text-blue-600">
          ...
          <div className="pt-4 flex flex-col md:flex-row gap-4 items-stretch max-w-3xl">
            <div className="relative grow">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 px-12 py-3 text-xs text-slate-800 focus:outline-none focus:border-blue-500 transition-colors"
              />
            </div>
              ...
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all border whitespace-nowrap ${
                    activeCategory === cat ? 'bg-blue-600 border-blue-600 text-white shadow-md' : 'bg-white border-slate-200 text-slate-500'
                  }`}
                >
                  {cat}
                </button>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 bg-slate-50 border border-slate-200 rounded-3xl p-8 md:p-12 shadow-sm relative overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4">
              <span className="text-[10px] font-mono font-bold text-emerald-600 uppercase tracking-wider">RECOVERY YIELD STAGE-3</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-200 font-mono text-[10px] text-slate-400">
                ...
                <div>YIELD RATE: <span className="text-emerald-600 font-bold">[DRAFT]%</span></div>
              </div>
            </div>
      ...
      <section className="py-24 bg-slate-50 border-b border-slate-200 text-left">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 space-y-2">
            <span className="text-xs font-bold uppercase tracking-widest text-blue-600 font-mono">Performance Audits</span>
      ...
      <section className="py-24 bg-white border-b border-slate-200 text-left">
        <div className="mx-auto max-w-4xl px-4">
          <div className="mb-12 space-y-2 text-center">
            <span className="text-xs font-bold uppercase tracking-widest text-blue-600 font-mono">Statutory Updates</span>
            ...
            {briefings.map((brief, idx) => (
              <div key={idx} className="bg-slate-50 border border-slate-200 p-6 rounded-2xl hover:border-slate-300 transition-all space-y-4">
                ...
                <div className="pt-2 border-t border-slate-200">
                  <a href="#inquiry" className="text-xs font-bold text-blue-600 hover:text-blue-700 flex items-center gap-1">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-6">
              <span className="text-xs font-bold uppercase tracking-widest text-blue-600 font-mono">Professional Training</span>
            ...
            <div className="lg:col-span-6 bg-white border border-slate-200 rounded-3xl p-6 shadow-sm font-mono text-xs text-left">
              ...
              <ul className="space-y-3 text-slate-600">
                <li className="flex justify-between border-b border-slate-200 pb-2"><span>Module 1: Fair Practice calling Hours Limits</span><span className="text-emerald-600">Lock config</span></li>
                <li className="flex justify-between border-b border-slate-200 pb-2"><span>Module 2: Customer Dispute Routing Desks</span><span className="text-emerald-600">Escalation SLA</span></li>
                <li className="flex justify-between border-b border-slate-200 pb-2"><span>Module 3: Address Absconders Forensics checks</span><span className="text-emerald-600">Compliance Limit</span></li>
                <li className="flex justify-between"><span>Module 4: Geotagged Site Check Verification</span><span className="text-emerald-600">GPS Validation</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white border-b border-slate-200 text-center">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
          <h3 className="text-lg font-bold font-sora text-amber-600 flex items-center justify-center gap-2">
            <BookOpen className="h-5 w-5 text-amber-600" /> Regulatory Code updates & Compliance Logs
          </h3>
      ...
      <section className="py-24 bg-slate-50 border-b border-slate-200 text-left">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 space-y-2">
            <span className="text-xs font-bold uppercase tracking-widest text-blue-600 font-mono">Recorded briefings</span>
      ...
      <section className="py-24 bg-white border-b border-slate-200 text-left">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-6">
              <span className="text-xs font-bold uppercase tracking-widest text-blue-600 font-mono">Market Stats</span>
            ...
            <div className="lg:col-span-6 grid grid-cols-2 gap-4">
              <div className="bg-slate-50 border border-slate-200 p-6 rounded-2xl">
                <div className="text-2xl font-bold font-sora text-emerald-600 flex items-center gap-1">
              ...
              <div className="bg-slate-50 border border-slate-200 p-6 rounded-2xl">
                <div className="text-2xl font-bold font-sora text-blue-600 flex items-center gap-1">
      ...
      <section className="py-24 bg-slate-50 border-b border-slate-200 text-left">
        <div className="mx-auto max-w-4xl px-4 bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold uppercase tracking-widest text-blue-600 font-mono">Stay Informed</span>
            ...
            {subbed ? (
              <div className="text-center py-6 space-y-2">
                <span className="text-xs font-bold text-emerald-600 font-mono">Subscription Confirmed</span>
      ...
      <section className="py-24 bg-white text-left" id="inquiry">
        <div className="mx-auto max-w-4xl px-4 bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-3xl p-8 shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div className="space-y-4">
              <span className="text-xs font-bold uppercase tracking-widest text-blue-600 font-mono">Advisory Panel</span>
            ...
            {inquirySubmitted ? (
              <div className="text-center py-12 space-y-2">
                <span className="text-xs font-bold text-emerald-600 font-mono">Inquiry Logged</span>
                <p className="text-[10px] text-slate-400 font-mono">Our legal coordinator will email you shortly.</p>
              </div>
            ) : (
              <form onSubmit={handleInquiry} className="space-y-3">
                <input required type="text" placeholder="Institution Name..." className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-blue-500" />
                <input required type="email" placeholder="Corporate Email..." className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-blue-500" />
                <textarea required placeholder="Outline specific portfolio queries (TAT, security logs, yard coordinates)..." className="w-full h-24 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-blue-500 resize-none"></textarea>
                <button type="submit" className="w-full rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs py-3 text-center transition-all shadow-md">
