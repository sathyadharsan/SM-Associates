    ...
    <section id="enquiry" className="py-24 bg-white">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={fUp}>
          ...
          <a href={cta.href || '/contact'} className="inline-flex items-center gap-2 rounded-full bg-brand-500 px-9 py-4 text-sm font-bold text-white shadow-sm hover:bg-brand-500 hover:scale-[1.02] transition-all duration-200">
