...
export const MAP_VIEWPORT = { x: 10, y: 18, w: 56, h: 80 };
...
export const MAP_MODES = [
  { id: 'coverage',    label: 'Coverage Mode',       tag: 'coverage',    color: ELECTRIC_BLUE },
  { id: 'collections', label: 'Collections Mode',    tag: 'collections', color: '#22D3EE' },
  { id: 'recovery',    label: 'Recovery Mode',       tag: 'recovery',    color: GOLD },
  { id: 'legal',       label: 'Legal Recovery Mode', tag: 'legal',       color: '#A78BFA' },
  { id: 'asset',       label: 'Asset Recovery Mode', tag: 'asset',       color: '#34D399' },
];

// ─── Office Locations ────────────────────────────────────────────────────
export const locations = [
  { id: 'chennai', name: 'Chennai', x: 43, y: 75, tier: 'hq',
  ...
  { id: 'bengaluru', name: 'Bengaluru', x: 35, y: 75, tier: 'regional',
  ...
  { id: 'hyderabad', name: 'Hyderabad', x: 38, y: 62, tier: 'regional',
  ...
  { id: 'coimbatore', name: 'Coimbatore', x: 33, y: 80, tier: 'branch',
  ...
  { id: 'madurai', name: 'Madurai', x: 37, y: 84, tier: 'branch',
  ...
  { id: 'trichy', name: 'Trichy', x: 39, y: 81, tier: 'branch',
  ...
  { id: 'salem', name: 'Salem', x: 37, y: 79, tier: 'branch',
  ...
  { id: 'tirunelveli', name: 'Tirunelveli', x: 35, y: 87, tier: 'branch',
  ...
  { id: 'pune', name: 'Pune', x: 23, y: 59, tier: 'branch',
  ...
  { id: 'ahmedabad', name: 'Ahmedabad', x: 19, y: 46, tier: 'branch',
  ...
  { id: 'jaipur', name: 'Jaipur', x: 29, y: 34, tier: 'branch',
  ...
  { id: 'lucknow', name: 'Lucknow', x: 45, y: 34, tier: 'branch',
  ...
  { id: 'kochi', name: 'Kochi', x: 31, y: 84, tier: 'branch',
...
export const HQ = locations.find(l => l.tier === 'hq');

// ─── Global command-center metrics — animated counters, mode-independent ──
export const globalMetrics = [
  { id: 'coverage', label: 'Coverage', value: 28, suffix: '', display: '28 States' },
  { id: 'officers', label: 'Field Officers', value: 500, suffix: '+' },
  { id: 'agents', label: 'Recovery Agents', value: 300, suffix: '+' },
  { id: 'cases', label: 'Active Cases', value: 50000, suffix: '+' },
  { id: 'visits', label: 'Monthly Visits', value: 100000, suffix: '+' },
  { id: 'success', label: 'Success Rate', value: 92, suffix: '%' },
];
