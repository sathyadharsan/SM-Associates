export const platformContent = {
  'recovery-operations': {
    ...
    capabilities: [
      {
        title: "Standardized Portfolio Ingestion",
        desc: "Ingests high-volume debt portfolios through secure transfer protocols. Establishes a secure and structured entry point for case files, preventing data leaks and classification errors.",
        bullets: [
          "Secure SFTP batch ingestion protocols",
          "Verification of debtor records against local registries",
          "Standardized initiation of case file audit dossiers"
        ],
        businessOutcome: "Prevents data fragmentation and establishes immediate operational control over the portfolio."
      },
      {
        title: "Standardized Escalation Workflow",
        desc: "Moves delinquent accounts through rules-based escalation paths based on risk parameters and aging. Prevents accounts from stalling in early default buckets by ensuring timely, compliant progression.",
        bullets: [
          "System-enforced calling hours lockout controls (08:00 AM - 07:00 PM)",
          "Dynamic risk-threshold doorstep visitation triggers",
          "Automatic escalations to legal panels upon verification failure"
        ],
        businessOutcome: "Compresses resolution turnaround times (TAT) and keeps accounts active in the recovery pipeline."
      },
      {
        title: "Geolocated Ground Sourcing",
        desc: "Deploys on-ground teams to perform field check-ins and verify borrower circumstances. Overcomes the blindspot of physical outreach by validating borrower presence and asset conditions.",
        bullets: [
      ...
      },
      {
        ...
        businessOutcome: "Safeguards institutional reputation and protects bank panel empanelments."
      },
      {
        ...
        bullets: [
          ...
          "Daily deposit reconciliation ledger uploads via secure channels"
        ],
        businessOutcome: "Enables risk committees to make informed settlement (OTS) and enforcement decisions."
      },
      {
        title: "Foreclosure Coordination Desk",
        desc: "Structured coordination of legal notices and physical property possessions. Speeds up collateral enforcement timelines under SARFAESI Act guidelines.",
        bullets: [
          "Notice coordination under Section 13(2) and 13(4) timelines",
          "District Magistrate Section 14 petition tracking and liaison",
          "Composite public notice executions (newspaper ads, site affixations)"
        ],
        businessOutcome: "Releases provisioning capital by converting delinquent assets into marketable collateral."
      }
    ],

    tabsHeading: "Enterprise Delivery Model",
    tabs: [
      {
        id: "operating-framework",
        label: "Operating Framework",
        heading: "Standardized Enterprise Delivery Controls",
        overview: "We coordinate collections tele-calling, geolocated doorstep outreach, and legal notice preparation into a single operating model. This integration eliminates vendor silos and speeds up portfolio resolution.",
        activities: [
          "Ingest portfolios via secure file transmission protocols",
          "Validate debtor credentials against local registries and municipal records",
          "Distribute case files to 19 regional branch grids based on coordinate mapping"
        ],
        documents: [
          "Portfolio intake verification logs",
          "Operational SLA parameters boundaries"
        ],
        risks: [
          "Delayed file registration or profile formatting discrepancies"
        ],
        deliverable: "Structured Portfolio Intake Record",
        benefit: "Consolidates all recovery operations under one accountable operating partner."
      },
      {
        ...
        risks: [
          "Script deviation during collections outreach",
          "Outbound calling hours infractions"
        ],
        deliverable: "Weekly Compliance Audit Dossier",
        benefit: "Protects empanelments by isolating banks from conduct liabilities."
      },
      {
        ...
        activities: [
          ...
          "Coordinate legal notice drafting with local panel advocates"
        ],
        documents: [
        ...
        deliverable: "Active Case Status Matrix",
        benefit: "Minimizes delinquency aging by preventing accounts from stalling."
      },
      {
        ...
        risks: [
          ...
          "Missing visit verification files in the case folder"
        ],
        deliverable: "Evidentiary Case Dossier",
        benefit: "Speeds up Section 14 CMM/CJM court filings by providing clean documentation."
      },
      {
        ...
        activities: [
          ...
          "Publish weekly performance dossiers for executive committees"
        ],
        documents: [
          "Daily cash deposit receipts",
          "Reconciled ledger audit files"
        ],
        risks: [
          "Reporting transmission delays or manual entry reconciliation errors"
        ],
        deliverable: "Weekly Management Information System (MIS) Report",
        benefit: "Enables bank recovery committees to make timely, data-backed decisions."
      },
      {
        id: "business-outcomes-tab",
        label: "Business Outcomes",
        heading: "Unlocking Provisions and Improving ROA",
        overview: "Our operating framework coordinates physical and legal actions to resolve defaulted portfolios, releasing capital locked in provisioning buckets.",
        activities: [
          "Track portfolio roll-back rates across delinquency buckets",
          "Monitor collateral possession warrant execution cycles",
          "Measure collections cost-to-recovery efficiency ratios"
        ],
        documents: [
          "NPA resolution status reports",
          "Released provisioning capital audit trails"
        ],
        risks: [
          "Extended court possession timelines",
          "Unsuccessful asset public auctions"
        ],
        deliverable: "Strategic Asset Resolution Report",
        benefit: "Directly improves bank profitability and Return on Assets (ROA)."
      }
    ],

    problemStatementEyebrow: "Operating Pressures",
    problemStatementHeading: "The Risk Gaps in Traditional Recovery Models",
    problemStatement: [
      {
        icon: "shieldAlert",
        title: "Compliance Exposure",
        desc: "Boards face direct liability under RBI Outsource Guidelines. Traditional collections methods that lack voice logger audits and certified staff present severe reputational and compliance risks."
      },
      {
        icon: "trendingDown",
        title: "Operational Fragmentation",
        desc: "Fragmented vendor structures coordinate call centers, ground agents, and advocate panels in isolation. This lack of coordination delays action, stalling default resolution."
      },
      {
        icon: "timer",
        title: "Evidentiary Gaps",
        desc: "Missing visit records and incomplete documentation trigger borrower court challenges. These drafting defects stall Section 14 CJM warrants, delaying physical possession for months."
      }
    ],

    overview: {
      heading: "Standardized Operating Framework: Coordinating Ground & Legal Assets",
      subheading: "Restoring Balance Sheet Quality through Regulatory and Operational Discipline",
      summary: "SM Associates operates a standardized risk operations framework designed for Scheduled Commercial Banks, NBFCs, and ARCs. By combining recorded tele-calling campaigns, geolocated doorstep outreach, and structured legal panels, we manage the complete recovery and foreclosure lifecycle. This integrated model ensures all collections actions strictly follow RBI guidelines while accelerating statutory timelines to free bank capital locked in NPA provisioning buckets.",
      outcomes: [
        {
      ...
      useCases: [
        {
          title: "Retail Portfolio Collections",
          desc: "Standardized campaigns using IIBF DRA-certified representatives."
        },
        {
          title: "Secured Asset Foreclosures",
          desc: "Coordinating Section 13 notice serving and Section 14 CJM possessions."
        }
      ]
    },

    challengesHeading: "Operating Challenges",
    challenges: [
      {
      ...
      },
      {
        ...
        desc: "Siloed communication between advocates and field teams delays the serving of demand notices, letting default cycles drag out.",
        warningBadge: "STATUTORY TIMELINES",
        impact: "SM Associates Approach: Direct coordination between legal desk trackers and regional branch offices."
      },
      {
    ...
    processFlow: {
      title: "The Core Operating Model",
      desc: "How defaulted portfolios move through our operational controls under strict SLA supervision.",
      steps: [
        {
          step: "01",
          title: "Portfolio Intake",
          desc: "Ingesting loan records through secure file transfer protocols and creating the case dossier.",
          outcome: "Case data validated and registered."
        },
        {
          step: "02",
          title: "Operational Assessment",
          desc: "Evaluating borrower profiles, default age, and collateral parameters to map the campaign.",
          outcome: "SLA boundaries and script parameters configured."
        },
        {
          step: "03",
          title: "Case Allocation",
          desc: "Assigning accounts to local regional branch grids and IIBF DRA-certified coordinators.",
          outcome: "Immediate ground mobilization within target districts."
        },
        {
          step: "04",
    ...
    outcomes: [
      {
        title: "Capital Allocation Velocity",
    ...
    targetIndustriesHeading: "Industries Served",
    targetIndustries: [
      {
        name: "Scheduled Commercial Banks",
        desc: "Executing high-volume retail collections and secured commercial possessions under strict regulatory oversight."
      },
      {
        name: "Retail NBFCs",
        desc: "Managing agricultural tractor and commercial vehicle defaults with IIBF DRA-certified field dispatching."
      },
      {
        name: "Housing Finance Companies",
        desc: "Coordinating residential mortgage foreclosures, property valuations, and public e-auctions."
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "By standardizing the escalation timeline, we minimize lag times between default, doorstep visit, and notice serving. This compressed cycle time accelerates accounts rollback to early buckets or speeds up possession warrants, directly releasing bank capital locked in NPA provisions."
      }
    ],

    cta: {
      heading: "Request an Operational Assessment",
      subheading: "Consult with our risk desk to evaluate how our standardized operating framework can compress your NPA cycle times and protect brand compliance.",
      buttonText: "Schedule Platform Consultation",
      href: "/contact"
    }
  },
  'recovery-os': {
    ...
    capabilities: [
      {
        title: "Secure Ingestion Registry",
        desc: "Imports delinquent loan books from banks and NBFCs through secure transfer protocols. Establishes a secure and structured entry point for case files, preventing data leaks and classification errors.",
        bullets: [
          "Secure SFTP batch ingestion protocols",
          "Verification of debtor records against local registries",
          "Standardized initiation of case file audit dossiers"
      ...
      {
        title: "Standardized Notice Desk",
        desc: "Tracks the production and serving of statutory demand notices. Prevents limitation lapses and procedural errors under Section 138 or SARFAESI.",
        bullets: [
          "Notice coordination under Section 13(2) and 13(4) timelines",
      ...
      },
      {
        ...
        desc: "Manages cash and payment receipts collected on the ground. Prevents collection leaks and ensures immediate settlement tracking.",
        bullets: [
          "Strict 24-hour window for depositing collected funds",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Public notice auction scheduling and publication logs"
        ],
        businessOutcome: "Converts bad loans back into active funds by accelerating legal resolution."
      }
    ],
    ...
    tabs: [
      {
        ...
        activities: [
          ...
          "Map debtor addresses to regional branch grids"
        ],
        documents: [
          "Portfolio file validation receipts",
          "Account SLA setup logs"
        ],
        risks: [
          "Debtor address formatting issues",
          "Incomplete loan profile fields"
        ],
        deliverable: "Unified Borrower Case File",
        benefit: "Eliminates operational silos, ensuring immediate, portfolio-scale control."
      },
      {
        id: "operational-governance",
        label: "Operational Governance",
      ...
      },
      {
        ...
        activities: [
          ...
          "Liaise with advocate panels for Section 138 notices"
        ],
        documents: [
        ...
        risks: [
          ...
          "Extended notice drafting gaps"
        ],
        deliverable: "Portfolio Escalation Report",
        benefit: "Compresses turnaround times by keeping cases moving through milestones."
      },
      {
        id: "documentation-standards",
        label: "Documentation Standards",
        ...
        deliverable: "Statutory Notice Evidentiary Dossier",
        benefit: "Expedites CJM court orders by compiling legally defensible evidence."
      },
      {
        id: "management-reporting",
        label: "Management Reporting",
        ...
        activities: [
          ...
          "Reconcile payment logs against loan accounts"
        ],
        documents: [
        ...
        risks: [
          ...
          "Manual ledger reconciliation delays"
        ],
        deliverable: "Daily Operations Performance Report",
        benefit: "Provides complete visibility to support executive decision-making."
      },
      {
        id: "business-outcomes-tab",
        label: "Business Outcomes",
        ...
        activities: [
          ...
          "Reconcile closed NPA records"
        ],
        documents: [
          "Reconciliation dossier",
          "Released provision capital log"
        ],
        risks: [
          "Statutory CJM court delays",
          "Delayed public e-auctions"
        ],
        deliverable: "Strategic Portfolio Outcomes Dossier",
        benefit: "Directly improves bank profitability and capital adequacy ratios."
      }
    ],

    problemStatementEyebrow: "Operating Pressures",
    problemStatementHeading: "The Challenges of Fragmented Debt Recovery Systems",
    problemStatement: [
      {
        icon: "trendingDown",
        title: "Data Silos",
        desc: "Lenders manage call center lists, field visits, and advocate panel filings across separate systems. This fragmentation delays default tracking, letting cases drag."
      },
      {
        icon: "shieldAlert",
        title: "Conduct Risk Exposure",
        desc: "Traditional collections lack strict calling lockouts and QA transcript checks. Vendor script violations trigger direct compliance audits under RBI rules."
      },
      {
        icon: "timer",
        title: "Evidentiary Gaps",
        desc: "Missing visit confirmations and incomplete notice records lead to court challenges, causing CJM Section 14 warrant delays."
      }
    ],
    ...
    targetIndustriesHeading: "Ecosystem Support",
    targetIndustries: [
      {
        name: "Scheduled Commercial Banks",
  ...
  'workflow-automation': {
    ...
    capabilities: [
      ...
      },
      {
        ...
        businessOutcome: "Compresses the time required to serve Section 13(2) and Section 138 notices."
      },
      {
      ...
      {
        title: "Auto Dialing Controls",
        desc: "Prevents dialed calls outside RBI hours (08:00 AM - 07:00 PM). Eliminates compliance risks associated with inappropriate hours outreach.",
        bullets: [
    ...
    tabs: [
      {
        ...
        documents: [
          "Rules-based escalation logic diagrams",
          "Regional grid coverage maps"
        ],
        risks: [
          "Incomplete debtor files stalling trigger criteria",
          "Advocate panel drafting delays"
        ],
        deliverable: "Standardized Case Routing Matrix",
        benefit: "Ensures immediate, milestone-driven account progression across portfolios."
      },
      {
        id: "operational-governance",
        label: "Operational Governance",
        ...
        benefit: "Shields lenders from regulatory conduct penalties."
      },
      {
        id: "execution-workflow",
        label: "Execution Workflow",
        ...
        documents: [
          "Case escalation timelines",
          "Advocate dispatch registries"
        ],
        risks: [
          "Delayed doorstep visit feedback syncs",
          "Court calendar delays and adjournments"
        ],
        deliverable: "Escalation Velocity Matrix",
        benefit: "Compresses delinquency durations by resolving cases at the earliest bucket."
      },
      {
        id: "documentation-standards",
        label: "Documentation Standards",
        heading: "Audit-Ready Dossiers",
        overview: "We compile clean evidentiary files at every stage, giving advocate panels verified proof to support court filings.",
        activities: [
        ...
        documents: [
          ...
          "Served Section 13(2) notice dossier"
        ],
        risks: [
          "Missing notice receipt cards in physical files",
          "Debtor address discrepancies during serving"
        ],
        deliverable: "Verified Case Evidence Dossier",
        benefit: "Speeds up Section 14 warrant approvals by delivering clean documentation."
      },
      {
        id: "management-reporting",
        label: "Management Reporting",
        ...
        documents: [
          "Daily cash deposits logs",
          "Reconciled ledger files"
        ],
        risks: [
      ...
      },
      {
        ...
        documents: [
          ...
          "Released provisioning capital log"
        ],
        risks: [
          "Extended court possession timelines",
          "Unsuccessful asset auction cycles"
        ],
        deliverable: "Return on Assets (ROA) Yield Report",
        benefit: "Improves banking Return on Assets (ROA) by accelerating asset recoveries."
      }
    ],

    problemStatementEyebrow: "Operating Pressures",
    problemStatementHeading: "The Overhead of Manual Handoffs",
    problemStatement: [
      {
        icon: "trendingDown",
        title: "Manual Handoff Gaps",
        desc: "Siloed collections networks rely on spreadsheets, causing handoff delays between calling and field teams, letting accounts age."
      },
      {
        icon: "timer",
        title: "Notice Service Delays",
        desc: "Uncoordinated legal panels delay demand notice drafting, letting default cycles drag out without statutory action."
      },
      {
        icon: "shieldAlert",
        title: "PII Exposure Risks",
        desc: "Insecure case files shared via email expose banks to customer data leaks and regulatory compliance penalties."
      }
    ],
    ...
    overview: {
      ...
      useCases: [
        ...
        },
        {
          ...
          desc: "Standardizing demand notice drafting and Section 14 petition filings."
        }
      ]
    },
    ...
    faqs: [
      {
        q: "Can escalation trigger rules be customized to our bank's parameters?",
        a: "Yes. Escalation rules are configured during portfolio setup, letting banks specify trigger boundaries for doorstep dispatches and notice preparation based on risk categories."
      },
      {
      ...
      },
      {
        ...
        a: "Yes. The notice desk tracks notice drafting by panel advocates, logging dispatch details and serving receipts to compile a complete case record."
      },
      {
        q: "How are collected cash payments reconciled?",
        a: "All cash collections must be deposited into the client recovery account within 24 hours of receipt. Deposit slips are audited, and ledger reports are synced daily, keeping audit trails clean."
      }
    ],
  ...
  'field-operations': {
    ...
    capabilities: [
      {
        ...
        desc: "Confirms field representative coordinates match borrower addresses. Captures verifiable ground-truth evidence of physical outreach.",
        bullets: [
          "Mobile check-ins locked to address coordinates",
          "Verification of local residence parameters",
          "Audit trail creation for bank risk reviews"
        ],
        businessOutcome: "Captures verifiable ground-truth evidence of physical outreach."
      },
      {
        ...
        businessOutcome: "Insulates lenders from collections conduct liabilities."
      },
      {
        title: "Site Photo Logger",
        desc: "Captures timestamped property and notice serving photos. Compiles clean visual verification records for legal cases.",
        bullets: [
      ...
      {
        title: "Route Cost Optimizer",
        desc: "Calculates optimal travel grids for representatives. Lowers operational overheads across regional branch offices.",
        bullets: [
    ...
    tabs: [
      {
        id: "operating-framework",
        label: "Operating Framework",
        heading: "Regional Branch Allocations",
        overview: "Field Operations manages on-ground dispatches across South India, assigning coordinator routes based on coordinate mapping to optimize resources.",
        activities: [
          "Assign debtor coordinates to nearest branch grids",
          "Track vehicle and asset locations through regional yards",
          "Dispatch certified field coordinators to verify addresses"
        ],
        documents: [
          "Regional branch coverage metrics",
          "Field agent dispatch logs"
        ],
        risks: [
          "Unmapped rural locations",
          "Incomplete address details in portfolios"
        ],
        deliverable: "Ground Dispatch Allocation Report",
        benefit: "Managed field outreach optimizing travel yields."
      },
      {
        id: "operational-governance",
        label: "Operational Governance",
        ...
        documents: [
          ...
          "Outreach compliance audit briefs"
        ],
        risks: [
          "Coercive behavior script deviations",
          "Out-of-hours doorstep visits"
        ],
        deliverable: "Field Compliance Audit Dossier",
        benefit: "Insulates banks from collections conduct liabilities."
      },
      {
        id: "execution-workflow",
        label: "Execution Workflow",
        heading: "Doorstep Consultation Loops",
        overview: "On-ground agents trace addresses, verify contact details, and obtain signatures, accelerating default bucket rollbacks.",
        activities: [
          "Execute doorstep check-ins at verified coordinates",
          "Verify borrower contact details and asset condition",
          "Collect settlement OTS proposals from borrowers"
        ],
        documents: [
          "Doorstep visit reports",
          "Reconciled collections receipt slips"
        ],
        risks: [
          "Non-cooperative borrowers",
          "Extended doorstep tracing timelines"
        ],
        deliverable: "Case Resolution Status File",
        benefit: "Speeds up default resolutions through physical presence."
      },
      {
        id: "documentation-standards",
        label: "Documentation Standards",
        ...
        risks: [
          ...
          "Missing visual proofs in files"
        ],
        deliverable: "Evidentiary Site Dossier",
        benefit: "Expedites CJM court approvals by providing clean documentation."
      },
      {
        id: "management-reporting",
        label: "Management Reporting",
        ...
        activities: [
          ...
          "Reconcile agent travel expenses against grids",
          "Map field operations locations across regions"
        ],
        documents: [
          "Daily collections registers",
        ...
        benefit: "Provides real-time visibility into collections costs and yields."
      },
      {
        id: "business-outcomes-tab",
        label: "Business Outcomes",
        ...
        documents: [
          "NPA resolution status logs",
          "Released provisioning capital records"
        ],
        risks: [
          "Extended repossession dispute timelines",
          "Delays in public asset auctions"
        ],
        deliverable: "Strategic Yield Report",
        benefit: "Improves bank profitability and Return on Assets (ROA)."
      }
    ],

    problemStatementEyebrow: "Operating Pressures",
    problemStatementHeading: "The Logistical Blindspot of Field Sourcing",
    problemStatement: [
      {
        icon: "trendingDown",
        title: "Unverified Agent Visits",
        desc: "Collections agencies submit paper logs that cannot be independently audited, risking unverified reports."
      },
      {
        icon: "shieldAlert",
        title: "Conduct Compliance Risks",
        desc: "Uncertified field staff using coercive tactics expose bank boards to regulatory compliance audits."
      },
      {
        icon: "timer",
        title: "Unreachable Borrowers",
        desc: "Lacking localized branches prevents agencies from performing timely visits to semi-urban and rural addresses."
      }
    ],
    ...
    overview: {
      ...
      outcomes: [
        {
          title: "Audited Visit Logs",
          desc: "Every doorstep visit is logged with timestamped location metadata."
        },
        {
      ...
      useCases: [
        {
          title: "Tractor and Vehicle Finance Outreach",
          desc: "Traced farm site check-ins and vehicle repossession yard custody."
        },
        {
          title: "Mortgage Foreclosures Liaison",
          desc: "Affixing Section 13 notices and executing court possession orders."
        }
      ]
    },
    ...
    challenges: [
      ...
      },
      {
        ...
        desc: "Managing field operations from centralized hubs delays doorstep outreach, allowing default books to age.",
        warningBadge: "COVERAGE LAGS",
        impact: "SM Associates Approach: 19 branch grids ensuring local coordinators are located close to cases."
      }
    ],
    ...
    faqs: [
      {
        q: "Do agents log visits when offline?",
      ...
      {
        q: "Are all doorstep representatives certified under RBI outsourcing rules?",
        a: "Yes. All on-ground agents hold active IIBF DRA certifications and pass background checks before file assignment."
      },
      {
        q: "How does the field app track Section 13 notice servings?",
        a: "Agents capture photos of the served notice or visual proofs of notice affixations, logging the coordinate details for legal case dossiers."
      },
      {
        q: "How do you handle collections reconciliations across remote branch grids?",
        a: "Cash collections must be deposited into the client recovery account within 24 hours of receipt. Deposit slips are audited and reconciled daily."
      }
    ],
  ...
  'compliance-monitoring': {
    ...
    capabilities: [
      ...
      {
        title: "Litigation Checklist Desk",
    ...
    tabs: [
      ...
      },
      {
        ...
        risks: [
          ...
          "Grievance registry tracking delays"
        ],
        deliverable: "Compliance Audit Performance Report",
        benefit: "Reputational shielding for bank empanelment standing."
      },
      {
        id: "execution-workflow",
        label: "Execution Workflow",
        ...
        risks: [
          ...
          "Filing delay during statutory reviews"
        ],
        deliverable: "Resolved Disputes Status Report",
        benefit: "Standardized escalation compressing resolution timelines."
      },
      {
        id: "documentation-standards",
        label: "Documentation Standards",
        ...
        risks: [
          "Incomplete notice receipts in folders",
          "Missing field visit logs in dossiers"
        ],
      ...
      },
      {
        id: "management-reporting",
        label: "Management Reporting",
        heading: "Daily Compliance Summaries",
        overview: "Lenders receive daily compliance updates, audit scores, calling log registers, and dispute summaries.",
        activities: [
          "Publish daily compliance audit score summaries",
          "Send dispute registers to bank panel committees",
        ...
        benefit: "Complete audit visibility for risk committees."
      },
      {
        id: "business-outcomes-tab",
        label: "Business Outcomes",
        heading: "Empanelment Asset Protection",
        overview: "Our compliance controls protect institutional reputations and empanelments while accelerating default resolution cycles.",
        activities: [
          "Track bank panel empanelment status",
          "Audit QA feedback scores from client panels",
          "Measure collections compliance pass rate"
        ],
        documents: [
          "Empanelment evaluation logs",
          "Released provisioning capital records"
        ],
        risks: [
    ...
    problemStatementEyebrow: "Operating Pressures",
    problemStatementHeading: "The Compliance Vulnerabilities in Collections",
    problemStatement: [
      {
        icon: "trendingDown",
        title: "Conduct Violations Exposure",
        desc: "Traditional collections lacking script audits and calling hour restrictions expose bank boards to regulatory compliance penalties."
      },
      {
        icon: "timer",
        title: "Auditing Gaps",
        desc: "Missing visit confirmations and unrecorded calls leave lenders unable to verify debtor contact details during audits."
      },
      {
        icon: "shieldAlert",
        title: "PII Security Audits",
        desc: "Sharing sensitive borrower details via insecure channels creates data leak liabilities under privacy rules."
      }
    ],
    ...
    challenges: [
      {
        title: "Script Deviation Risks",
        desc: "Dialer representatives using non-approved scripts expose lenders to compliance complaints and panel suspensions.",
        warningBadge: "CONDUCT CONTROLS",
        impact: "SM Associates Approach: Weekly QA audits checking call transcripts for script compliance."
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Lenders can request a copy of our internal code of conduct, agent training guides, and audit logs during the panel empanelment process."
      }
    ],

    cta: {
      heading: "Secure Your Collections Portfolio",
      subheading: "Consult with our compliance desk to evaluate how our strict controls protect bank reputations and empanelment standing.",
      buttonText: "Consult with Compliance Desk",
      href: "/contact"
    }
  },
  'recovery-analytics': {
    ...
    capabilities: [
      ...
      {
        title: "Route and Cost Optimizer",
        desc: "Identifies efficient travel grids for field check-in dispatching. Reduces ground travel expenses and increases visit frequency.",
        bullets: [
    ...
    tabs: [
      ...
      },
      {
        id: "execution-workflow",
        label: "Execution Workflow",
        heading: "Placements and Campaign Triggers",
        ...
        benefit: "High-yield campaigns focusing resources on high-potential cases."
      },
      {
        id: "documentation-standards",
        label: "Documentation Standards",
      ...
      },
      {
        id: "business-outcomes-tab",
        label: "Business Outcomes",
        heading: "Provision Capital Releases",
        overview: "Data-driven placements shorten default durations, helping banks release provisioning reserves and improve Return on Assets.",
        activities: [
        ...
        risks: [
          "Delayed warrant approvals in court",
          "Unsuccessful property e-auction cycles"
        ],
        deliverable: "Strategic Return on Assets Report",
        benefit: "Maximized Return on Assets (ROA) through optimized spending."
      }
    ],

    problemStatementEyebrow: "Operating Pressures",
    problemStatementHeading: "The Wasted Cost of Unscanned Collections",
    problemStatement: [
      {
        icon: "trendingDown",
        title: "Inaccurate Field Dispatching",
        desc: "Sending agents to uncontactable or low-propensity borrower addresses drives up travel overheads."
      },
      {
        icon: "timer",
        title: "Uncalibrated Settlement Targets",
        desc: "Setting OTS settlement figures without local pricing data leads to delayed settlements or lower recoveries."
      },
      {
        icon: "shieldAlert",
        title: "Data Security Vulnerability",
        desc: "Exchanging loan data through insecure channels exposes banks to compliance audits under privacy laws."
      }
    ],

    overview: {
      heading: "Predictive Portfolio Analytics: Data-Driven Credit Sourcing",
      subheading: "Optimizing Placements and Ground Resources to Maximize Collections Yields",
      summary: "Our recovery analytics framework unifies historic payment behaviors and geographic records. By scoring default propensities and calculating optimal dispatch grids, we help risk desks target collections resources to maximize yields.",
      outcomes: [
        {
          title: "Optimized Sourcing",
          desc: "Directs field coordinators to high-probability accounts, lowering travel overheads."
        },
        {
          title: "Data-Driven Settlement",
          desc: "Provides local market pricing benchmarks to support OTS decisions."
        }
      ],
      useCases: [
        {
          title: "Retail NPA Portfolios Scoping",
          desc: "Scoring delinquent personal loan lists to select calling and dispatch actions."
        },
        {
          title: "Foreclosure Valuation Estimations",
          desc: "Benchmarking residential mortgage collateral valuations ahead of auctions."
        }
      ]
    },
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. Scoring parameters are configured during onboarding to align with the bank's historic default records and risk categories."
      },
      {
        q: "Do you publish cost-to-recovery reports for risk committees?",
        a: "Yes. Lenders receive weekly reports detailing recovered funds, ground travel costs, and campaign efficiency."
      },
      {
        q: "Can we review sample analytics reports before empanelment?",
        a: "Yes. Redacted templates and portfolio diagnostics reports are available to bank panels during empanelment evaluations."
      }
    ],

    cta: {
      heading: "Predict and Optimize Recovery Yields",
      subheading: "Consult with our analytics desk to evaluate how our diagnostics models can optimize collections placements and lower travel costs.",
      buttonText: "Consult with Analytics Desk",
      href: "/contact"
    }
  },
  'ai-recovery': {
    ...
    problemStatementEyebrow: "Operating Pressures",
    problemStatementHeading: "The Limits of Manual Operational Scoping",
    problemStatement: [
      {
        icon: "trendingDown",
        title: "Unpredictable Call Response Gaps",
        desc: "Traditional outbound dialing suffers from low call response rates, delaying borrower outreach campaigns."
      },
      {
        icon: "timer",
        title: "Manual Route Planning",
        desc: "Field coordinators mapping travel routes manually face high travel overheads and low visit frequency."
      },
      {
        icon: "shieldAlert",
        title: "Notice Assembly Delays",
        desc: "Manual verification of property deeds and contract records delays notice drafting, dragging out defaults."
      }
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. Model parameters are configured during onboarding to align with the bank's historic default records and risk categories."
      },
      {
