  ...
  return (
    <section id="careers" className="bg-slate-50 py-20 sm:py-24 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {careerPositions.map((position, index) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-950">{position.title}</h3>
        ...
        >
          <Users className="mx-auto h-12 w-12 text-gray-950" />
          <h3 className="mt-6 text-2xl font-semibold text-gray-950">Join Our Team of 300+ Professionals</h3>
