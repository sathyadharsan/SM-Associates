          ...
          {kpis.map((kpi, index) => {
            ...
            return (
              ...
              >
                ...
                {kpi.value ? (
                  <>
                    <div className="text-5xl font-semibold tracking-[-0.04em] text-navy-900 sm:text-6xl lg:text-7xl">
                      <AnimatedCounter value={kpi.value} suffix={kpi.suffix} />
                    </div>
                    <p className="mt-4 text-lg font-semibold text-navy-900">{kpi.label}</p>
                  </>
                ) : (
                  <>
                    <div className="text-4xl font-semibold tracking-[-0.035em] text-navy-900 sm:text-5xl">{kpi.label}</div>
                    <p className="mt-4 text-lg font-semibold text-navy-900">Operations</p>
                  </>
                )}
