          ...
          {capabilities.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className={`glass-card group relative overflow-hidden rounded-[24px] p-7 transition duration-300 hover:-translate-y-1 hover:border-[#0072bc]/40 hover:shadow-enterpriseHover ${className}`}
              >
                <div className="absolute -right-10 -top-10 h-28 w-28 rounded-full bg-brand-500/10 blur-2xl transition duration-300 group-hover:bg-brand-500/20" />
                <div className="relative">
                  ...
                  <a href="#contact" className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-gray-900 transition group-hover:text-[#0072bc]">
